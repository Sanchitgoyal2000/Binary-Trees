void distance(struct Node *root,int *a,int *b,int level,int dist);//acc to distance allocated to each node
void bottomView(Node *root)
{
    ...
    {
        b[i]=100;
        a[i]=-100;  // -100  because we have to take greater values
    }
